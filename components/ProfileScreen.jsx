      ...
      <div style={{ flex:1, padding:'24px 26px', overflowY:'auto', paddingBottom:40 }}>
          ...
          <div>
            ...
            <div style={{ borderTop:`1px solid ${C.faint}`, paddingTop:24 }}>
              ...
              {[
                ...
                { icon:'🗑️', label:'Delete my account', action:() => {}, danger:true },
              ].map((item,i) => (
        ...
        {section === 'security' && (
          <div>
            ...
            <Input label="Confirm new password"  type="password" value="" onChange={() => {}} placeholder="Re-enter new password" />
            <Btn s={{ width:'100%', padding:'16px 0', fontSize:F.lg, marginBottom:28 }}>Update Password ✦</Btn>
